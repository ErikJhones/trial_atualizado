...
- Conta no [wandb](https://wandb.ai/) com chave e projeto configurados.

## montando repositório
1. Criar o ambiente virtual  
**Com venv**
```bash
python -m venv trials
```

**Com conda**
```bash
conda create -n trials python=3.11.0
```

2. Ativar o ambiente virtual  
**Com venv**
```bash
source trials/bin/activate
```
...
```bash
python -m trials.scripts.train_trials
```
